...
public class DatabaseHelper {
    public static void testSetup() {
        ...
        List<Reward> rewards = new ArrayList<>();
            slots.add(new Slot(Constants.SLOT_BRONZE_FURNACE, 1, 1, 2, 5, 1, 5, Constants.SLOTS_4_MAX_ROUTES, Constants.RES_BRONZE_ORE, 4, Enums.SlotType.Furnace, Enums.Tier.Bronze, 1, 0));
            ...
            slots.add(new Slot(Constants.SLOT_BRONZE_WEAPON, 1, 1, 2, 5, 1, 5, Constants.SLOTS_3_MAX_ROUTES, Constants.RES_BRONZE_BAR, 3, Enums.SlotType.Weapon, Enums.Tier.Bronze, 1, 0));
            ...
            slots.add(new Slot(Constants.SLOT_BRONZE_ARMOUR, 1, 1, 2, 5, 1, 5, Constants.SLOTS_3_MAX_ROUTES, Constants.RES_BRONZE_BAR, 3, Enums.SlotType.Armour, Enums.Tier.Bronze, 1, 0));
            ...
            slots.add(new Slot(Constants.SLOT_BRONZE_TOOL, 1, 1, 2, 5, 1, 5, Constants.SLOTS_3_MAX_ROUTES, Constants.RES_BRONZE_BAR, 3, Enums.SlotType.Tool, Enums.Tier.Bronze, 1, 0));
            ...
            slots.add(new Slot(Constants.SLOT_BRONZE_ACCESSORY, 1, 1, 2, 5, 1, 5, Constants.SLOTS_3_MAX_ROUTES, Constants.RES_BRONZE_BAR, 3, Enums.SlotType.Accessory, Enums.Tier.Bronze, 1, 0));
