...
public class DatabaseHelper {
    public static void testSetup() {
        ...
        List<Slot> slots = new ArrayList<>();
            slots.add(new Slot(Constants.SLOT_BRONZE_CRAFTING, 1, 1, 2, 5, 1, 5, Constants.SLOTS_4_MAX_ROUTES, Constants.RES_BRONZE_ORE, 3, Enums.Type.Crafting, Enums.Tier.Bronze));
        Slot.saveInTx(slots);
